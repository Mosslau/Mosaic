// project/src/main/java/com/example/vehicle/AuthConfig.java —— JWT 登录与 CORS 配置（项目级）
...
// 认证（你是谁）本阶段用 jjwt + 拦截器解决；授权（你能报哪台车）是 ph15 Spring Security 内容。
...
public class AuthConfig implements WebMvcConfigurer {
    ...
    /** 拦截器：/api/vehicles/** 需要 Bearer token（登录接口除外）。 */
