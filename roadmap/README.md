...
| [智能大数据平台工程师.md](智能大数据平台工程师.md) | 工程部分 · 数据平台 | 通用数据平台 / 数据智能方向的工程师成长路径 |
...
> 工程侧的落地实现：数据平台 → [`../engineering/data-platform/`](../engineering/data-platform/)；AI 平台 → [`../engineering/ai-platform/`](../engineering/ai-platform/)。
