...
//! ```
//!
//! 对照 Python 版 ../../python/s14_cron_scheduler/code.py。
//! 运行：cargo run -p s14_cron_scheduler
//! 可选环境变量：EFFORT_LEVEL / MAX_TOKENS / ANTHROPIC_BETA / S01_DEBUG / FALLBACK_MODEL_ID / STREAM_THINKING
//! 对照 Python 版 ../../python/s13_background_tasks/code.py。
//! 运行：cargo run -p s13_background_tasks
...
async fn main() {
    ...
    println!("s14: Cron Scheduler — 按时间表生产工作");
