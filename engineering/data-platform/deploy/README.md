...
| 2026-09-20 | deploy/ 全目录注释去日期化：日期/轮次/"实测踩到"等叙事标记全部移除（compose、alerts、prometheus.yml、limits.xml、Dockerfile、emqx.conf、acl.conf、seed-users.sh、clickhouse.yaml、规则测试文件），只留规则与判据本体 | 修订记录只放本附录；配置文件注释 = 当前事实 |
