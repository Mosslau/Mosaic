...
- 实现基础 compaction
- 实现 Mini Raft KV 的单节点状态机
- 实现 brute-force vector search
- 实现 HNSW toy version
- 用 Axum 暴露 KV / 检索 API
- 用 pyo3 暴露 Rust 解析函数给 Python
