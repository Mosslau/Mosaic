// project/src/main/java/com/example/device/GlobalExceptionHandler.java —— 全局异常处理
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DeviceService.BusinessException.class)
    public ResponseEntity<ApiResponse<Void>> handleBusiness(DeviceService.BusinessException ex) {
