// examples/ex05-metrics-consumer/MetricConsumerService.java —— 消费服务：poll + 幂等 + 提交 offset
...
public final class MetricConsumerService {
    ...
    public MetricConsumerService(MiniKafka kafka, long startOffset, int batchSize) {
        this.kafka = kafka;
    ...
    public long pollAndProcess() {
        ...
        for (MetricMessage msg : batch.messages()) {
    ...
    private void processMsg(MetricMessage msg) {
