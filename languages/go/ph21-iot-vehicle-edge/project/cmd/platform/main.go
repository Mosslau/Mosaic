// 来源：ph21-iot-vehicle-edge project/cmd/platform/main.go
// 一句话说明：云端接入平台进程入口——env 配置 + API 服务 + 优雅退出。构建注入：
//
//	go build -ldflags "-X tenetlang/go/ph21-iot-vehicle-edge/project/internal/version.Version=v1.0.0 -X tenetlang/go/ph21-iot-vehicle-edge/project/internal/version.Commit=abc123 -X tenetlang/go/ph21-iot-vehicle-edge/project/internal/version.BuildTime=2026-09-04T00:00:00Z" -o /tmp/edge-platform ./cmd/platform
//
...
import (
	...
	"tenetlang/go/ph21-iot-vehicle-edge/project/internal/config"
	"tenetlang/go/ph21-iot-vehicle-edge/project/internal/platform"
	"tenetlang/go/ph21-iot-vehicle-edge/project/internal/version"
)
