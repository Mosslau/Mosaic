...
- [`tenet/design-notes.md`](tenet/design-notes.md) — **设计文档 · 溯源**：三语言吸收矩阵、每个特性从哪来、拒绝了什么
- [`tenet/grammar.md`](tenet/grammar.md) — **设计文档 · 规范**：正式文法（EBNF）、类型系统、求值语义（唯一事实来源）
...
- [`tenet/tenet.md`](tenet/tenet.md) — 语言与编译器入口（速览、文档导航、演进）
